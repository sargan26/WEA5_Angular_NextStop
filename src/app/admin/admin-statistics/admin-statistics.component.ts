...
import {AdminStatisticsService} from '../../services/admin-statistics/admin-statistics.service';
...
export class AdminStatisticsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private statisticsService: AdminStatisticsService) {
